...
func TestErrorHandling(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if errObj.Message != tt.expectedMessge {
			t.Errorf("wrong error message. expected=%q, got=%q", tt.expectedMessge, errObj.Message)
		}
	}
}
...
func TestFunctionApplication(t *testing.T) {
	...
	for _, tt := range tests {
		testIntegerObject(t, testEval(tt.input), tt.expcted)
	}
}
